        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="post" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Custom Components:</h6>
                        <a class="collapse-item" href="../backend/addpost.php">Add post</a>
                        <a class="collapse-item" href="../bachend/allpost.php">All post</a>
                    </div>
                </div>
            </li>
                            ...
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <?php
                                     if(isset($_SESSION['userdata']['first_name'])){
                                         print_r($_SESSION['userdata']['first_name']);
                                     } else{
                                        echo" nobody";
                                     }   ?>                                                   
                                </span>
                                <img class="img-profile rounded-circle"
                                    src="https://avatars.dicebear.com/api/initials/:<?php
                                     if(isset($_SESSION['userdata']['first_name'])){
                                         print_r($_SESSION['userdata']['first_name']);
                                     } else{
                                        echo" nobody";
