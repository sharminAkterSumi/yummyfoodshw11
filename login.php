...
<img src="../image/cake1.jpg" alt="" style="width:100%;display:block;">
...
<input type="file" id="img"class="d-none">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="../controller/logindesign.php" method="POST">
